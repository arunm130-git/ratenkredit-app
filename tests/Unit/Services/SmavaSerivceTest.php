...
class SmavaServiceTest extends TestCase
{
    private ClientInterface $clientMock;
    private SmavaService $service;
    ...
    protected function setUp(): void
    {
        ...
        $this->service = new SmavaService($configMock, $this->clientMock);
    ...
    public function testFetchLoanOffersReturnsFormattedData(): void
    {
        ...
        $this->mockHttpClientResponse('{"Interest": 5.00, "Terms": {"Duration": 24}}');
    ...
    public function testFetchLoanOffersThrowsExceptionOnInvalidResponse(): void
    {
        ...
        $this->expectExceptionMessage('Invalid API response format from Smava: {"invalid_field":"value"}');
